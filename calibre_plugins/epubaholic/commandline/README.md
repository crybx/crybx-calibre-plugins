##  Running Epubaholic from the command line

### INTRODUCTION

The `me.py` script file is a Python script designed for calibre users
to allow running the Epubaholic plugin from the command line rather
...
- If you have a particular set of options you want to repeatedly run, you
  ...
  example can be found in `example.cmd` in the Epubaholic zip file.
