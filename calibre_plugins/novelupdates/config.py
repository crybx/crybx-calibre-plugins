...
KEY_UPDATE_LANGUAGE       = 'updateLanguage'     # bool
...
class ConfigWidget(QWidget):
    ...
    def __init__(self, plugin_action):
        ...
        # Language
        self.update_language_cb = QCheckBox('Update Language', self)
        self.update_language_cb.setChecked(c.get(KEY_UPDATE_LANGUAGE, DEFAULT_STORE_VALUES[KEY_UPDATE_LANGUAGE]))
        field_layout.addWidget(self.update_language_cb, row, 0, 1, 3)
        row += 1
    ...
    def save_settings(self):
        new_prefs = {
            ...
            KEY_UPDATE_LANGUAGE:      self.update_language_cb.isChecked(),
